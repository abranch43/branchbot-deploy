...
def test_filters_keywords_and_regions(tmp_path):
    opps = [
        Opportunity(id='1', title='Janitorial Service', agency='MO', location='Springfield', category=None, source='x', url='u', due_date=None, created_at=None, raw={}),
        Opportunity(id='2', title='IT Support', agency='Dept', location='Kansas City', category=None, source='x', url='u', due_date=None, created_at=None, raw={}),
    ]
